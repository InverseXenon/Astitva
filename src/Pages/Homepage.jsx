        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8">
              Join Astitva to connect with a supportive community, find opportunities, track your health, and access
              resources designed for women of all backgrounds.
            </p>
            <div className="flex flex-wrap gap-4">
              <Button size="lg" className="text-black-700 hover:bg-white/90 ">
                Join Now
              </Button>
  ...
  <div className="container mx-auto px-4">
    <div className="text-center mb-16">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto">
        Astitva provides a comprehensive set of tools and resources designed specifically for women's empowerment
        and well-being.
      </p>
    </div>
